...
train_data$dbt <- train_data$Annual.Income * train_data$Debt.To.Income.Ratio
test_data$dbt <- test_data$Annual.Income * test_data$Debt.To.Income.Ratio
valid_data$dbt <- valid_data$Annual.Income * valid_data$Debt.To.Income.Ratio

test_data$Class1 <- as.factor(test_data$Class)
train_data$Class1 <- as.factor(train_data$Class)
valid_data$Class1 <- as.factor(valid_data$Class)

test_data$Class <- NULL
train_data$Class <- NULL
valid_data$Class <- NULL
