...
#oversample the rare class and undersample the class with creditworthy the data and then use that for modelling.
train_smt <- ubSMOTE(train_data[,-ncol(train_data)], train_data$Class, perc.over = 200, k = 5, perc.under = 175, verbose = TRUE)
table(train_smt$Y)
train_data <- train_smt$X
train_data$Class <- train_smt$Y
