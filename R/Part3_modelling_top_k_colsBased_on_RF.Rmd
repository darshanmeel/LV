...
md_prms <- train_and_predict_random_forest_and_ret_auc(frml1,train_data,valid_data)
auc <- md_prms$auc
...
md_prms <- train_and_predict_random_forest_and_ret_auc(frml1,train_data,test_data)
auc <- md_prms$auc
