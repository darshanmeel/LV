...
frml1 <- 'Class ~ Loan.Term + FICO.Credit.Score + Use.Of.Credit.Line + Annual.Income  + Total.Credit.Balance + Total.Number.Of.Credit.Lines + Loan.Purpose + Earliest.Credit.Line.Opened + Loan.Amount + Debt.To.Income.Ratio'
